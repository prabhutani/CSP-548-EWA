...
public class AccessoryList extends HttpServlet {
	...
	/* Accessory Page Displays all the Accessories and their Information in Laptop Speed */
...
//		String VoiceAssistantName = request.getParameter("voiceAssistant");
...
//		VoiceAssistant voiceAssistant = hm.get(VoiceAssistantName);
		...
		for(Map.Entry<String, VoiceAssistant> entry : hm.entrySet())
		{
			...
			for(Map.Entry<String, String> acc:voiceAssistant.getAccessories().entrySet())
			{
				...
				pw.print("<li><form method='post' action='Cart'>" +
						...
						"<input type='hidden' name='access' value='"+voiceAssistant.getName()+"'>"+
